  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-sans text-2xl md:text-3xl font-bold text-[#F5F5F5]">Newsletter</h1>
          <p className="text-sm text-[#888888] mt-1">{total} abonnés inscrits aux alertes.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-[#161616] rounded-xl border border-[rgba(255,255,255,0.07)] p-6 hover:bg-[#1A1A1A] transition-colors">
          <p className="text-xs font-bold text-[#888888] uppercase tracking-wider mb-2">Total abonnés</p>
          <p className="text-4xl font-black text-[#F5F5F5]">{total}</p>
        </div>
        <div className="bg-[#161616] rounded-xl border border-[rgba(255,255,255,0.07)] p-6 hover:bg-[#1A1A1A] transition-colors">
          <p className="text-xs font-bold text-[#888888] uppercase tracking-wider mb-2">Nouveaux ce mois</p>
          <p className="text-4xl font-black text-[#1D9E75]">+{newThisMonth}</p>
        </div>
        <div className="bg-[#161616] rounded-xl border border-[rgba(255,255,255,0.07)] p-6 hover:bg-[#1A1A1A] transition-colors">
          <p className="text-xs font-bold text-[#888888] uppercase tracking-wider mb-2">Nouveaux cette semaine</p>
      ...
      <div className="bg-[#161616] rounded-xl border border-[rgba(255,255,255,0.08)] overflow-hidden">
        ...
        <Table>
          <TableHeader className="bg-[#111111]">
            <TableRow>
              <TableHead className="w-16 text-center text-[#666666]">#</TableHead>
              <TableHead className="text-[#666666]">Email</TableHead>
              <TableHead className="text-[#666666]">Date d'inscription</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {isLoading ? (
              <TableRow><TableCell colSpan={3} className="text-center py-8 text-[#888888]">Chargement...</TableCell></TableRow>
              ...
              filteredSubs.map((row, idx) => (
                <TableRow key={row.id} className="hover:bg-[#1A1A1A]">
                  ...
                  <TableCell className="font-bold text-[#F5F5F5]">{row.email}</TableCell>
              ...
              <TableRow><TableCell colSpan={3} className="text-center py-8 text-[#888888]">Aucun abonné trouvé.</TableCell></TableRow>
            )}
          </TableBody>
        </Table>
      </div>
