...
import { Compass, Calendar, MapPin, Users, Heart, Laptop, Image as Paintbrush, Scale, Check, Phone, MessageSquare } from "lucide-react";
...
const poleDetails = {
  ...
  arts: {
    ...
    sub: "Architecture · Mode · Graphisme",
    spots: 15,
    timeline: [
  ...
  business: {
    title: "Business & Droit",
    icon: <Scale className="h-6 w-6 text-primary" />,
    sub: "Gestion · Finance · Juridique",
    spots: 5,
    timeline: [
...
export default function JPOPage() {
  const [activePole, setActivePole] = useState<"sante" | "tech" | "arts" | "business">("sante");
  ...
  return (
    <div className="w-full bg-background min-h-screen text-foreground overflow-x-hidden flex flex-col pt-20">
      ...
      <main className="flex-1 w-full">
        ...
        <section className="relative min-h-[60vh] w-full flex items-center justify-center py-16 overflow-hidden bg-dots">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-8 text-center flex flex-col items-center">
            <Badge variant="outline" className="px-3.5 py-1 text-xs border-primary/30 text-primary uppercase mb-6 tracking-widest bg-[#141414]/90 animate-pulse">
              ⚡ Journée d'Immersion · Avr–Mai 2026
            </Badge>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
              ...
              <span className="bg-[#141414] border border-border/10 px-3.5 py-1.5 rounded-full text-xs font-semibold hover:text-primary transition-colors cursor-default">💻 Tech & Innovation</span>
              <span className="bg-[#141414] border border-border/10 px-3.5 py-1.5 rounded-full text-xs font-semibold hover:text-primary transition-colors cursor-default">🎨 Arts & Design</span>
              <span className="bg-[#141414] border border-border/10 px-3.5 py-1.5 rounded-full text-xs font-semibold hover:text-primary transition-colors cursor-default">⚖️ Business & Droit</span>
            </div>
        ...
        {/* SECTION 8: UNIVERSITY MARQUEE */}
        <section className="w-full py-12 bg-[#0F0F0F] relative border-t border-border/10 overflow-hidden">
          <div className="relative w-full overflow-hidden">
            ...
            <div className="animate-marquee flex gap-12 whitespace-nowrap items-center font-serif text-lg font-bold text-[#888888] opacity-75">
              <span className="hover:text-primary transition-colors cursor-default">ISCOM DAKAR</span>
              <span className="text-primary/30">•</span>
              <span className="hover:text-primary transition-colors cursor-default">ESTM SÉNÉGAL</span>
              <span className="text-primary/30">•</span>
              <span className="hover:text-primary transition-colors cursor-default">ARTA DESIGN SCHOOL</span>
              <span className="text-primary/30">•</span>
              <span className="hover:text-primary transition-colors cursor-default">MS DAMETIS PARIS</span>
              <span className="text-primary/30">•</span>
              <span className="hover:text-primary transition-colors cursor-default">UNIVERSITY UNG CONGO</span>
              <span className="text-primary/30">•</span>
                ...
                <div className="space-y-1.5 sm:col-span-1">
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      { value: "tech", label: "💻 Pôle Tech & Innovation" },
                      { value: "arts", label: "🎨 Pôle Arts & Design" },
                      { value: "business", label: "⚖️ Pôle Business & Droit" },
                    ]}
                  />
                </div>
                <div className="space-y-1.5 sm:col-span-1">
